  ...
  <div className="min-h-screen bg-[color:var(--hub-bg)]">
    ...
    <main className="mx-auto max-w-4xl px-6 py-14 pb-24">
      ...
      <Section title="3. Your account">
        ...
        <p>Notify us immediately at <strong className="text-[color:var(--hub-text)]">legal@skillstream.app</strong> if you suspect unauthorised access to your account.</p>
      ...
      <Section title="6. Payments and subscriptions">
        ...
        <p>If you cancel a subscription within 7 days of your first payment and have not yet delivered any paid lessons to students, you may request a full refund by contacting <strong className="text-[color:var(--hub-text)]">legal@skillstream.app</strong>.</p>
